    ...
    <footer className="w-full">
      ...
      >
        <div className="container mx-auto flex flex-col md:flex-row justify-between items-center">
          <h2 className="text-white font-urbanist text-2xl md:text-3xl font-medium mb-4 md:mb-0">
            Let&apos;s Work Together
          </h2>
          <div className="flex flex-row gap-3">
            <Link
              href="mailto:example@email.com?subject=Inquiry from Website&body=Hello, I'd like to discuss a project with you."
              className="flex items-center font-urbanist justify-center gap-2 text-white border border-white rounded-[8px] px-5 py-2 transition-colors"
            >
            ...
            <Link
              href="#"
              className="flex items-center font-urbanist justify-center gap-2 bg-white text-[#007BFF] rounded-[8px] px-5 py-2 transition-colors"
            >
            ...
            <nav>
              <ul className="flex flex-wrap justify-center gap-x-6 gap-y-2">
                ...
                <li>
                  <Link
                    href="#services"
                    className="text-[#000000] hhover:text-[#007BFF]"
                  >
                    Services
                  </Link>
                </li>
