  ...
  return (
    <main className="w-full md:min-h-[700px] lg:min-h-[800px] bg-[#f0f7ff] overflow-hidden flex justify-center">
      <div className="flex flex-col items-center relative pt-3 bg-[#F0F7FF] w-full max-w-[1000px] px-4 md:px-6">
        ...
        {/* Call to Action Buttons - UPDATED WITH REDUCED WIDTHS FOR MOBILE */}
        <Card className="w-[85%] max-w-[400px] mx-auto md:absolute md:bottom-5 md:left-1/2 md:transform md:-translate-x-1/2 flex flex-col sm:flex-row h-auto sm:h-[50px] items-center justify-center gap-2 sm:gap-1 p-1 sm:p-1 bg-[#ffffff1a] rounded-[8px] overflow-hidden backdrop-blur-[7.5px] backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(7.5px)_brightness(100%)] mb-8 md:mb-0 z-20 relative">
          <CardContent className="p-0.5 flex flex-col sm:flex-row w-full gap-2 sm:gap-3">
            <Button className="w-[80%] sm:w-[48%] mx-auto sm:mx-0 flex items-center justify-center px-3 py-1.5 sm:px-4 sm:py-1.5 bg-[#007bff] rounded-[8px] overflow-hidden border-[0.5px] border-solid border-[#cfd4dc] h-[40px]">
              <a
                href="#projects"
            ...
            <Button
              variant="ghost"
              className="w-[80%] sm:w-[48%] mx-auto sm:mx-0 flex font-medium items-center justify-center gap-1 px-2 py-1.5 sm:px-3 sm:py-1.5 rounded-[8px] overflow-hidden h-[40px] border-[0.5px] border-solid border-[#cfd4dc]"
            >
              <Link href="https://www.linkedin.com/in/rashini-kaweesha" className="[font-family:'Inter',Helvetica] font-medium text-black text-sm sm:text-base tracking-[-0.30px] leading-[normal]">
                Let&apos;s Connect
              </Link>
            </Button>
          </CardContent>
